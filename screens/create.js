    ...
    render() {
        ...
        return ( 
            <View style={styles.container}>
                ...
                <TextInput maxLength={4} style={styles.textInput} placeholder="Title"
                    onChangeText={text => this.setState({title: text})}
                    
                />
                
                 <Picker maxLength={4} style={styles.textInput}
                onChangeText={(itemValue, itemIndex) => setSelectedValue(itemValue)}>
                ...
                <TextInput maxLength={4} style={styles.textInput} placeholder="Address"
                    onChangeText={text => this.setState({address: text})}
                    
                />
                <TextInput maxLength={4} style={styles.textInput} placeholder="Rooms"
                    onChangeText={text => this.setState({rooms: text})}
                    
                />
                <TextInput maxLength={4} style={styles.textInput} placeholder="Price"
                    onChangeText={text => this.setState({price: text})}
                    
                />
                <TextInput maxLength={4} style={styles.textInput} placeholder="Area"
                    onChangeText={text => this.setState({area: text})}
                    
                />
                <TextInput maxLength={4} style={styles.textInput} placeholder="Owner"
